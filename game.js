(() => {
  ...
  blasterReferenceImage.src = 'data:image/png;base64,';
  ...
  function drawBlasterHead(bullet, active) {
    if (blasterReferenceImage.complete && blasterReferenceImage.naturalWidth) {
      ...
      g.drawImage(blasterReferenceImage, -16, -12, 31, 24);
      g.restore();
      return;
    }
    ...
    for (const bullet of bullets) {
      if (bullet.kind === 'beam') {
        ...
        if (boneProjectileImage.complete && boneProjectileImage.naturalWidth) {
          g.drawImage(boneProjectileImage, bullet.x - 4, bullet.y - bullet.h, 9, bullet.h);
        } else {
