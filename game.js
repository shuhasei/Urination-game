(() => {
  ...
  boneProjectileImage.src = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAeCAYAAADkftS9AAAACXBIWXMAAAPoAAAD6AG1e1JrAAAALklEQVR4nGP4DwUMDAwMcPZ/LIABWQVcAAYwBEBgVHBYB8h/JIAhAJdAVgFjAwBj+79BkYHkiAAAAABJRU5ErkJggg==';
  const blueBoneProjectileImage = new Image();
  blueBoneProjectileImage.src = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAeCAYAAADkftS9AAAACXBIWXMAAAPoAAAD6AG1e1JrAAAALUlEQVR4nGNgePf/PxiDwDsYG8ZAxmCAIQADGAIgMCo4rAPkHb7UgZGWkBQAAFX6jEH68QnwAAAAAElFTkSuQmCC';
    ...
    for (const bullet of bullets) {
      if (bullet.kind === 'beam') {
        ...
        if (boneImage.complete && boneImage.naturalWidth) {
          g.drawImage(boneImage, bullet.x - 2, boneTop, 5, bullet.h);
        } else {
  ...
  function updateEnemyTurn(dt, now) {
    ...
    for (const bullet of bullets) {
      ...
      if (bullet.kind === 'beam') {
        ...
        hit = Math.abs(bullet.x - heart.x) < 4
          && heart.y > boneTop - 4
